...
**** Description ****
This file provides the TopicMetricsDelegate. It is used to change the state of
in the TopicMetricsModel. It therefore provides the UI with an editor and
pushes the newly entered data to the model.
"""
